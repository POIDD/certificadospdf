<?php
    ...
    $pdf->Cell(45,10,utf8_decode('ARTICULO'),1,0,'C',0);
    $pdf->Cell(70,5,utf8_decode('CANTIDAD PERIODO ENTREGADO'),1,0,'C',0);
    $pdf->Ln(5);
    $pdf->SetX(105);
    $pdf->Cell(70,5,utf8_decode('abr - 27'),1,0,'C',0);

    $pdf->SetFont('Arial','',10);
    $pdf->Ln(5);
    $pdf->SetX(40);
    $pdf->Cell(20,10,utf8_decode('P009'),1,0,'C',0);
    $pdf->Cell(45,10,utf8_decode('Pantalon tipo senderismo'),1,0,'C',0);
    $pdf->Cell(70,10,utf8_decode('1'),1,0,'C',0);
    $pdf->Ln(5);
    ...
    $pdf->Ln(6);
    $pdf->SetFont('Arial','',10);
    $pdf->Cell(20,10,utf8_decode('Entiende y acepta que los accesorios periféricos entregadas para el desarrollo de sus funciones, y con esto la'),0,0,'L',0); 
    $pdf->Ln(5);
    $pdf->Cell(20,10,utf8_decode('organización cumple con la exigencia  de la solicitud.'),0,0,'L',0); 
    $pdf->Ln(7);
    ...
    $pdf->Ln(5);
    $pdf->Cell(20,10,utf8_decode('trabajador(a) firma el presente comprobante de entrega de accesorios.'),0,0,'L',0); 
    $pdf->Ln(12);
